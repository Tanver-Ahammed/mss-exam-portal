-------------------------------------geo------------------------------
INSERT INTO divisions (division_id, name, name_local, url)
VALUES (1, 'Chattagram', 'চট্টগ্রাম', 'www.chittagongdiv.gov.bd'),
...
INSERT INTO districts (district_id, division_id, name, name_local, lat, lon, url)
VALUES (1, 1, 'Comilla', 'কুমিল্লা', '23.4682747', '91.1788135', 'www.comilla.gov.bd'),
       ...
       (46, 6, 'Manikganj', 'মানিকগঞ্জ', '23.8602262', '90.776575', 'www.manikganj.gov.bd'),
...
INSERT INTO upazilas (UPAZILA_ID, DISTRICT_ID, NAME, NAME_LOCAL, URL)
VALUES (1, 1, 'Debidwar', 'দেবিদ্বার', 'debidwar.comilla.gov.bd'),
